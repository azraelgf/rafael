(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero__body")) new swiper_core_Swiper(".hero__body", {
        ...
        if (document.querySelector(".images-product__slider")) {
            const thumbsSlider = new swiper_core_Swiper(".images-product__thumbs", {
    ...
    function documentActions(e) {
        const targetElement = e.target;
        if (targetElement.closest(".header-search__mobile")) document.querySelector(".header-search").classList.toggle("_show");
        if (targetElement.closest(".favourite-btn")) targetElement.classList.toggle("_active");
        if (!e.composedPath().includes(document.querySelector(".header-search"))) document.querySelector(".header-search").classList.remove("_show");
    }
    window["FLS"] = false;
    isWebp();
    menuInit();
